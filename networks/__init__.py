...
def define_net(opt):
    ...
    if which_model == 'FAWDN':
        ...
        net = FAWDN(in_channels=opt['in_channels'], out_channels=opt['out_channels'],
                                  num_features=opt['num_features'], num_steps=opt['num_steps'],nBlock = opt['nBlock'], nDenselayer= opt['nDenselayer'],
