...
class SRSolver(BaseSolver):
    ...
    def _overlap_crop_forward(self, x, shave=10, min_size=10000, bic=None):
        """
    ...
    def load(self):
        ...
        if (self.is_train and self.opt['solver']['pretrain']) or not self.is_train:
            ...
            if self.is_train:
                ...
                #     name_parameter = self.model.named_parameters()
                #     for k, v in self.model.named_parameters():
                #         if k.find('Blocks2')<0 and k.find('conv_out')<0:
    ...
    def print_network(self):
        ...
        """
        # flops, _ = self.get_flops(self.model, (3,48,48))
